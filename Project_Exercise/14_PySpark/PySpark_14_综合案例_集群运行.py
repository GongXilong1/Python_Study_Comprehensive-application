# 106.75.35.228:8080/cluster/nodes  提交到这个集群去运行
"""
演示PySpark综合案例
"""
from pyspark import SparkConf, SparkContext
import os
os.environ['PYSPARK_PYTHON'] = "集群中Linux的python解释器位置"
os.environ['HADOOP_HOME'] = "集群中Linux的Hadoop的位置"
...
# 读取文件转换成RDD
file_rdd = sc.textFile("改成hdfs文件系统的路径")
